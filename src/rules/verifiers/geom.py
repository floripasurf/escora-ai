...
_GEOM_002 = Rule(
    ...
    category="GEOM",
    source=Source(
        type="engineer_qa", ref="Supplier practice",
...
# --- GEOM-005: Cotas from concreted structure (Supplier p.23) ---
...
_GEOM_005 = Rule(
    id="GEOM-005",
    category="GEOM",
    source=Source(type="manual", ref="Supplier p.23"),
    description_pt=(
...
# --- GEOM-006: Alvenaria offset <= 5cm (Supplier p.107, regra 12) ---

_GEOM_006 = Rule(
    id="GEOM-006",
    category="GEOM",
    source=Source(type="manual", ref="Supplier p.107 regra 12"),
    description_pt=(
...
# --- GEOM-007: Barrote edge offset (Supplier p.105-106, regra 11 — corrected) ---
...
_GEOM_007 = Rule(
    id="GEOM-007",
    category="GEOM",
    source=Source(type="manual", ref="Supplier p.105-106 regra 11"),
    description_pt=(
