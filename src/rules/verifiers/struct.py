...
# --- STRUCT-002: Forcado not on cantilever (Supplier p.109, regra 14) ---
...
_STRUCT_002 = Rule(
    id="STRUCT-002",
    category="STRUCT",
    source=Source(type="manual", ref="Supplier p.109 regra 14"),
    description_pt=(
...
# --- STRUCT-003: Tower at center for 3-support beams (Supplier p.110, regra 15) ---

_STRUCT_003 = Rule(
    id="STRUCT-003",
    category="STRUCT",
    source=Source(type="manual", ref="Supplier p.110 regra 15"),
    description_pt=(
