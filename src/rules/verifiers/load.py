...
All load-related rules from NBR 15696 and Supplier training.
"""
...
_LOAD_001 = Rule(
    id="LOAD-001",
    category="LOAD",
    source=Source(type="norm", ref="NBR 15696:2009 §4.2 + Supplier p.26"),
...
_LOAD_003 = Rule(
    id="LOAD-003",
    category="LOAD",
    source=Source(type="manual", ref="Supplier p.109 regra 14 (hiperestaticidade)"),
    description_pt=(
...
# --- LOAD-005: Substrate stress check (Supplier p.25) ---

_LOAD_005 = Rule(
    id="LOAD-005",
    category="LOAD",
    source=Source(type="manual", ref="Supplier p.25"),
    description_pt=(
