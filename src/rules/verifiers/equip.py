...
_EQUIP_001 = Rule(
    id="EQUIP-001",
    category="EQUIP",
    source=Source(type="manual", ref="Decision chain Q1 + Supplier p.12"),
...
# --- EQUIP-002: Telescópica capacity check (Supplier p.11 curves) ---

_EQUIP_002 = Rule(
    id="EQUIP-002",
    category="EQUIP",
    source=Source(type="manual", ref="Supplier p.11"),
    description_pt=(
...
# --- EQUIP-004: External beam constraints (Supplier p.111, regra 16 parte A) ---

_EQUIP_004 = Rule(
    id="EQUIP-004",
    category="EQUIP",
    source=Source(type="manual", ref="Supplier p.111 regra 16 parte A"),
    description_pt=(
...
# --- EQUIP-005: Internal beam constraints (Supplier p.112-113, regra 16 parte B) ---

_EQUIP_005 = Rule(
    id="EQUIP-005",
    category="EQUIP",
    source=Source(type="manual", ref="Supplier p.112-113 regra 16 parte B"),
    description_pt=(
