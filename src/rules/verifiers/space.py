...
_SPACE_001 = Rule(
    id="SPACE-001",
    category="SPACE",
    source=Source(type="norm", ref="AGENTS.md spacing table + Supplier p.89"),
    description_pt=(
...
# --- SPACE-003: Plywood seam alignment (Supplier p.114-115, regra 17) ---

_SPACE_003 = Rule(
    id="SPACE-003",
    category="SPACE",
    source=Source(type="manual", ref="Supplier p.114-115 regra 17"),
    description_pt=(
