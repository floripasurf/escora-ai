...
def _project_worker(project_id: str, input_data: dict, output_dir: str) -> None:
    ...
    try:
        ...
        project_store.update_project_result(project_id=project_id, result=result)
    except Exception as e:
        logger.exception(f"Project {project_id} failed")
        project_store.update_project_result(project_id=project_id, result={
            "status": "error",
...
async def create_project(
    ...
    project_store.create_project(
        project_id=project_id,
        locadora_id=branch.locadora_id,
        branch_id=branch.id,
...
async def get_project_status(
    ...
    data = project_store.get_project(project_id, branch_id=branch.id)
    if not data:
